...
***********************************************;
***Descarga de datos de 2021 y 2022;
***********************************************;

quietly forvalues i=21(1) 22 {;
quietly forvalues j=1(1) 4 {;
copy "https://www.inegi.org.mx/contenidos/programas/enoe/15ymas/microdatos/enoe_n_20`i'_trim`j'_dta.zip" archivos.zip, replace;
unzipfile archivos.zip, replace;
**Borrar archivos innecesarios;
...
***********************************************;
***Descarga de datos de 2023 y 2024;
***********************************************;

quietly forvalues i=23(1) 24 {;
quietly forvalues j=1(1) 4 {;
copy "https://www.inegi.org.mx/contenidos/programas/enoe/15ymas/microdatos/enoe_20`i'_trim`j'_dta.zip" archivos.zip, replace;
unzipfile archivos.zip, replace;
**Borrar archivos innecesarios;

capture erase "ENOE_COE1T`j'`i'.dta";
capture erase "ENOE_COE2T`j'`i'.dta";
capture erase "ENO_VIVT`j'`i'.dta";
capture erase "ENO_HOGT`j'`i'.dta";
